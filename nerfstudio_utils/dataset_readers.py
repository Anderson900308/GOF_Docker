...
def readColmapSceneInfo(path, method, images, eval, llffhold=8):
    info_path = os.path.join(path, "colmap", method, "0")
    
    try:
        cameras_extrinsic_file = os.path.join(info_path, "images.bin")
        cameras_intrinsic_file = os.path.join(info_path, "cameras.bin")
        cam_extrinsics = read_extrinsics_binary(cameras_extrinsic_file)
        cam_intrinsics = read_intrinsics_binary(cameras_intrinsic_file)
    except:
        cameras_extrinsic_file = os.path.join(info_path, "images.txt")
        cameras_intrinsic_file = os.path.join(info_path, "cameras.txt")
    ...
    ply_path = os.path.join(info_path, "points3D.ply")
    bin_path = os.path.join(info_path, "points3D.bin")
    txt_path = os.path.join(info_path, "points3D.txt")
